...
describe UsersController do
	...
	describe "GET 'show'" do
		...
		it "should the user's microposts" do
			mp1 = Factory(:micropost, :user => @user, :content => "test string")
			mp2 = Factory(:micropost, :user => @user, :content => "string test")
			get :show, :id => @user
		...
		it "should display the micropost count" do
			10.times { Factory(:micropost, :user => @user, :content => "test")}
			get :show, :id => @user
  ...
  describe "PUT 'update'" do
	...
	describe "success" do
		...
		before(:each) do
			@attr = {:name => "New name", :email => "usera@exampl.org",
  ...
  describe "authentication of update/edit actions" do
	...
	describe "for signed-in users" do
		...
		before(:each) do
			wrong_user = Factory(:user, :email => "user@examplee.net")
